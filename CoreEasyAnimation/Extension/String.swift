...
extension CharacterSet {
 ...
 extension NSAttributedString {
    func customAttributedText(firstString:String,
        ...
        attributedText.setAttributes([kCTFontAttributeName as NSAttributedString.Key:UIFont.systemFont(ofSize: fontSize)], range: range)
        attributedText.addAttribute(NSAttributedString.Key.foregroundColor, value: color , range: range)

        return attributedText
    }
    
    func strokeUnderLine(string:String) -> NSMutableAttributedString {
        let attributes: [NSAttributedString.Key : Any] = [.strokeWidth: -3.0,
                                                         .strokeColor: UIColor.yellow,
                                                         .foregroundColor: UIColor.red]
        
        return NSAttributedString(string: string, attributes: attributes) as! NSMutableAttributedString
    }
